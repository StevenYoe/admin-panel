<!--
    ...
    - Displays detailed information about a specific job position
    - Super Admins can edit or delete the position
    - Shows a list of users assigned to this position
...
@section('content')
    ...
    <div class="mt-6">
        <x-card title="Daftar Pengguna dengan Jabatan Ini">
            ...
            @else
                <!-- Message if no users in this position -->
